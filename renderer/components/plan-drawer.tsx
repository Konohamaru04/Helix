...
function TaskRow(props: { task: CapabilityTask; onDelete?: (() => void) | undefined }) {
  ...
  return (
    <div className="motion-card rounded-2xl border border-white/10 bg-slate-950/50 px-4 py-3">
      ...
      <div className="mt-2 flex items-center justify-between gap-3">
        ...
        {onDelete ? (
          <button
            ...
            className="motion-interactive shrink-0 rounded px-2 py-1 text-[10px] font-medium text-rose-300 transition hover:bg-rose-400/10 hover:text-rose-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-400"
            onClick={onDelete}
            type="button"
          >
            Delete
