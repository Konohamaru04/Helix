  ...
  return (
    <div className="motion-app-shell relative min-h-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      <main className="relative flex min-h-screen items-center justify-center px-6 py-12">
        <section className="motion-panel w-full max-w-3xl rounded-[2rem] border border-white/10 bg-slate-900/80 p-8 shadow-panel backdrop-blur">
          <p className="motion-text-reveal text-xs uppercase tracking-[0.3em] text-cyan-200/70">
            Desktop Runtime Required
          </p>
          <h1 className="motion-text-reveal-delayed mt-4 text-4xl font-semibold text-white">
          ...
          <div className="motion-panel-delayed mt-8 rounded-2xl border border-white/10 bg-slate-950/80 p-5 text-sm text-slate-300">
