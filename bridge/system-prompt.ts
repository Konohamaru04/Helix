...
export function buildPrimarySystemPrompt(input: {
  ...
  return [
    ...
    '',
    'Capability catalog:',
    '- Use tools when they materially improve correctness, grounding, or execution.',
    '- If another system message already activates a specific skill, follow that active skill prompt over this catalog.',
    '- If no skill is already active, internally adopt the single best matching skill behavior from the listed skills.',
